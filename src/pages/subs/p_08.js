	...
	return (
		<div className="overflow-x-hidden">
			...
			<Container>
				...
				<p className="text-2xl text-center mt-14" style={{ marginBottom: 580 }}>
					글로벌 엔터테크 기업 갤럭시코퍼레이션은 가상과 현실을 공존시켜, 인류의
					삶을
					<br />더 행복하고 이롭게 재창조하는 메타버스 아바타 포탈 기업입니다
				</p>
				<h3 className="text-3xl eng text-center mb-4">core value</h3>
				<h3 className="text-4xl eng text-center mb-6">
					METAVERSE AVATA POrtAL
				</h3>
				<Box className="mb-5" />
				<p className="text-base mb-64">
					연예인 IP로 만들어진 AVA와 갤럭시 세계관을 기반으로 미디어, 콘텐츠
					제작, 매니지먼트, 커머스, 버추얼 휴먼, ESG 등 메타버스 A to Z 사업을
					하는 메타버스포털 기업 입니다.
				</p>
				...
				<p className="text-base mb-64">
					...
					메타버스 아바타 포탈 기업입니다. 전세계 70억 명 인구가 다양 한
					아바타로 공생하는 신인류의 세상을 창조합니다.
				</p>
				<h3 className="text-3xl eng text-center mb-4">VISION</h3>
				<h3 className="text-4xl eng text-center mb-6">
					open the infinite world
				</h3>
				<Box className="mb-5" />
				<p className="text-base mb-64">
					우리는 무한의 콘텐츠 세계의 새로운 메타버스 세계를 만들고 그곳에 서
					모든 사람들이 행복을 찾고 꿈을 이룰수 있는 새로운 세상을 열고 그이를
					통해 일상에서의 자아실현을 시켜 현실을 바꾸는것 그것이 우리의
					비젼입니다.
				</p>
			</Container>
		</div>
