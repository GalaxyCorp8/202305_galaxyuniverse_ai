...
const resources = {
	ko: {
		translation: {
			cmp1: "슈퍼 IP 메타버스 AI 기업",
			cmp1_1:
				"갤럭시코퍼레이션은 가상과 현실을 공존시켜, 인류의 삶을 더 행복하고 이롭게 재창조하는 슈퍼 IP 메타버스 AI 기업입니다.",
			cmp1_2:
				"전 세계의 메타버스를 넘나들며 자사의 무한한 메타버스 콘텐츠, 플랫폼, 비즈니스 등을 통해 전세계 70억명 인구가 다양한 아바타로 공생하는 신인류의 세상을 창조하여 인류의 행복한 삶에 기여합니다.",
			cmp1_3:
				"우리는 글로벌 슈퍼 IP 메타버스 AI 기업으로 미래 산업의 비즈니스를 혁신하며, 슈퍼 IP를 기반으로 글로벌 최고의 메타버스 AI 기업을 지향합니다. 이를 통해 인류의 삶에 긍정적인 영향을 주며 다양한 꿈을 실현시키는 슈퍼 IP 메타버스 AI 기업으로서의 역할을 수행하고 노력합니다.",
			cmp1_4:
				"슈퍼 IP를 활용하여, 양질의 갤럭시 콘텐츠와 갤럭시 세계관을 만들어갑니다. 이를 바탕으로 IP 매니지먼트, 콘텐츠 제작, 버추얼 휴먼, ESG 등 다양한 비즈니스 분야에서 활동하며, 메타버스 A to Z를 통합한 AI 메타버스 포털 기업으로 성장하고 있습니다.",
			cmp1_5:
			...
			biz1: "갤럭시코퍼레이션은 국내 최초 슈퍼 IP 메타버스 AI 기업입니다.<br />현실과 가상의 조화를 통한 ‘행복’을 최우선 가치로 두고 메타버스 FIRST MOVER로서<br />IP, 컨텐츠, 테크를 메타버스와 융복합하여 비즈니스를 진행하고 있습니다.",
