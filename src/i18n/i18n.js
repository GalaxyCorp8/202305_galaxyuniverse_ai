...
const resources = {
	ko: {
		translation: {
			cmp1: "슈퍼 IP 기반 AI 메타버스 기업",
			cmp1_1:
				"갤럭시코퍼레이션은 가상과 현실을 공존시켜, 인류의 삶을 더 행복하고 이롭게 재창조하는 슈퍼 IP 기반 AI 메타버스 기업입니다.",
			cmp1_2:
				"전 세계의 메타버스를 넘나들며 자사의 무한한 메타버스 콘텐츠, 플랫폼, 비즈니스 등을 통해 전세계 70억명 인구가 다양한 아바타로 공생하는 신인류의 세상을 창조하여 인류의 행복한 삶에 기여합니다.",
			cmp1_3:
				"우리는 글로벌 슈퍼 IP 기반 AI 메타버스 기업으로 미래 산업의 비즈니스를 혁신하며, 슈퍼 IP를 기반으로 글로벌 최고의 AI 메타버스 기업을 지향합니다. 이를 통해 인류의 삶에 긍정적인 영향을 주며 다양한 꿈을 실현시키는 슈퍼 IP 기반 AI 메타버스 기업으로서의 역할을 수행하고 노력합니다.",
			cmp1_4:
				"슈퍼 IP를 활용하여, 양질의 갤럭시 콘텐츠와 갤럭시 세계관을 만들어갑니다. 이를 바탕으로 IP 매니지먼트, 미디어, 버추얼 휴먼, 커머스, ESG 등 다양한 비즈니스 분야에서 활동하며, 메타버스 A to Z를 통합한 슈퍼 IP 기반 AI 메타버스 기업으로 성장하고 있습니다.",
			cmp1_5:
				"넷플릭스 예능 시청시간 글로벌1위 피지컬:100 방영(루이웍스 미디어)",
			cmp1_6: "예능 제작사 루이웍스 미디어/WDM엔터테인먼트/루돌프 미디어 인수",
			cmp1_7:
				"메타버스 AI 음악쇼 TV조선 아바드림 방영 복싱선수 매니 파퀴아오 아바타 매니지먼트 MOU 체결",
			...
			biz1: "갤럭시코퍼레이션은 국내 최초 슈퍼 IP 기반 AI 메타버스 기업입니다.<br />현실과 가상의 조화를 통한 ‘행복’을 최우선 가치로 두고 메타버스 FIRST MOVER로서<br />IP, 미디어, 커머스, 테크를 메타버스와 융복합하여 비즈니스를 진행하고 있습니다.",
			...
			media1_1: "미디어 콘텐츠",
			media1_2:
				"국내 주요 예능, 버라이어티 콘텐츠 제작 스튜디오를<br />M&A하여 국내/글로벌 화제성 TOP 수준의 콘텐츠 제작 역량을 보유하고 있습니다.",
			media1_3:
	...
	en: {
		translation: {
			...
			biz1: "Galaxy Corporation is the first metaverse AI avatar portal company in Korea. As a metaverse first mover prioritizing ‘happiness’ via coexistence of reality and virtual reality, we are converging IP, content, commerce, and tech, with metaverse avatars.",
	...
	jp: {
		translation: {
			...
			cmp1_16_2:
				"メタバースアバターショー「テレビ朝鮮・サブキャラ全盛期」を放映",
			...
			cmp1_22:
				"㈱Euraboration法人の子会社を買収（ユーチューブコンテンツスタジオ",
			biz1: "ギャラクシーコーポレーションは、韓国初のメタバースAIアバターポータル企業です。現実と仮想の調和を通じた「幸せ」を最優先価値として、メタバースFIRST MOVERとしてIP、コンテンツ、コマース、テクをメタバースアバターと融・複合してビジネスを進めています。",
