...
const resources = {
	ko: {
		translation: {
			...
			cmp1_4:
				"아ss티스트를 비롯한 다양한 전문가들의 IP를 활용하여, 양질의 갤럭시 아바타와 갤럭시 미리내 세계관을 만들어갑니다. 이를 바탕으로 IP 매니지먼트, 콘텐츠 제작, 버추얼 휴먼, 커머스, ESG 등 다양한 비즈니스 분야에서 활동하며, 메타버스 A to Z를 통합한 메타버스 포털 기업으로 성장하고 있습니다.",
			cmp1_5:
			...
			biz1: "갤럭시코퍼레이션은 국내 최초 메타버스 AI 아바타 포탈 기업입니다.<br />현실과 가상의 조화를 통한 ‘행복’을 최우선 가치로 두고 메타버스 FIRST MOVER로서<br />IP, 컨텐츠, 커머스, 테크를 메타버스 아바타와 융복합하여 비즈니스를 진행하고 있습니다.",
