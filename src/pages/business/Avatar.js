...
const Avatar = () => {
	...
	return (
		<>
			...
			>
				<a href="https://galaxyava.com/" target="_blank" rel="noreferrer">
					<img src={MsMd} className="hidden sm:block" alt="" />
					<img src={MsXs} alt="" className="block sm:hidden" />
				</a>
			</div>
			...
			>
				<Link to="/page/ip">
					<img src={AvaMd} className="hidden sm:block" alt="" />
					<img src={AvaXs} alt="" className="block sm:hidden" />
				</Link>
			</div>
			<h2 className="text-2xl lg:text-5xl lg:leading-snug eng text-center mt-32 mb-0 lg:mb-2">
				HUMAN
			...
			<div className="container flex justify-center">
				<Link to="/page/human">
					<img src={HpMd} className="hidden sm:block" alt="" />
					<img src={HpXs} alt="" className="block sm:hidden" />
				</Link>
			</div>
		</>
	);
