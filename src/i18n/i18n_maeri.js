...
const resources = {
	...
	en: {
		translation: {
			...
			cmp1_7:
				'Broadcasting of Metaverse AI music show “AVA Dream” on TV Chosun
Boxer Manny Pacquiao’s avatar management MOU signed',
			...
			cmp1_16_2: 'Broadcasting of Metaverse Avatar Show TV Chosun “Sub-Character Heyday”',
			...
			cmp1_19: 'Attracted seed investment from T Investment and Sing Song GTI Co.,Ltd',
			cmp1_20:
			...
			biz1:
				'Galaxy Corporation is the first metaverse AI avatar portal company in Korea.
As a metaverse first mover prioritizing ‘happiness’ via coexistence of reality and virtual reality, we are converging IP, content, commerce, and tech, with metaverse avatars.',
			ava1_1: 'Infinitely Expanding Galaxy IP',
			ava1_2:
				'Galaxy Corporation creates metaverse avatars for celebrities and expands into various channels of multiverse IP. Through past collaborations with over 80  celebrities in various fields,
Galaxy Corporation possesses the biggest and largest Avatar IP business know-how and portfolio in Korea',
			ava1_3: 'Infinitely Expanding Galaxy Multi-Metaverse Universe',
			ava1_4:
				'The world of ‘Mirinae’ splits into two: reality through light “Light on”, and the virtual world visible in the absence of light “Black on”.
In the real world, our lives flow along countless fleeting lines. Where the moment and choice intersect creates the current state, and the moment you imagine your dream it will come true.',
			ava1_5:
				'AVA is the core value of Galaxy that fulfills dreams in real life allowing the experience of various dreams, and hyperconnects reality with the future.
Galaxy strives to fulfill various dreams through AVA and connect more people to a larger world to change the world with messages of dreams and hope beyond new experiences in everyday life.',
			ava1_6: 'Artists and Experts of Galaxy Corporation',
			ava1_7:
				'Galaxy Corporation continuously discovers and communicates with various artists and experts. Through communication, Galaxy Corp ensures high compatibility and sustained management.
Galaxy Human is the first global metaverse creator in Korea and can to grow together with a bigger world with infinite potential.
Galaxy strives for and supports various origin creators who can grow.',
			...
			cms1_6:
				'Utilizing years of accumulated know-how,
commerce branding, service, design, and even marketing, Galaxy Corporation provides e-commerce related services that cover all on/offline aspects.',
			cms1_7: 'Partners',
			...
			care1_3: 'Exploration',
			care1_4: 'Someone who explores the infinite world with passion and curiosity',
			care1_5: 'Execution',
			...
			care1_17:
				'We support PTO and expenses for those who want to become parents',
			...
			care1_31:
				'We support professional care to those in need of help.',
			news1: 'Galaxy News',
			news2: 'Press Release',
			news3:
				'Galaxy Corporation Awarded 'Minister of SME’s Award for Regulatory Innovation'',
			news4:
				'"AVA Dream" Delivers Dreams and Hopes.
Three “Special Points to Watch Out For."',
			news5: 'Press',
			news11: 'Galaxy News',
...
<br /><br />Choi Yong-ho, Chief Happiness Officer of Galaxy Corporation, expressed his gratitude for receiving the Minister's Award, stating, "It is an honor to receive this award," and added, "We will strive to achieve our goal of listing on the KOSDAQ next year, working tirelessly to ensure the global metaverse industry grows together."',
	...
	jp: {
		translation: {
			...
			cmp1_1:
				'ギャラクシーコーポレーションは、仮想と現実を共存させ、人類の生活を
より幸せかつ有益に再創造するメタバースAIアバターポータル企業です。',
			cmp1_2:
			...
			cmp1_7:
				'メタバースAI音楽ショー「テレビ朝鮮・アバドリーム」を放映
ボクシング選手マニパキアオのアバターマネジメントMOUを締結',
			cmp1_8:
			...
			cmp1_20:
				'㈱ペルソナユニバース法人を設立（CJ ENM SPC）
サブキャラオーディションバラエティ「Mnet・サブキャラ選抜大会」を放映',
			cmp1_21: '㈱Big Flash法人の子会社を買収（マーケティング/広告代理）',
			cmp1_22: '㈱Euraboration法人の子会社を買収（ユーチューブコンテンツスタジオ',
			biz1:
				'ギャラクシーコーポレーションは、韓国初のメタバースAIアバターポータル企業です。
現実と仮想の調和を通じた「幸せ」を最優先価値として、メタバースFIRST MOVERとして
IP、コンテンツ、コマース、テクをメタバースアバターと融・複合してビジネスを進めています。',
			ava1_1: '無限に広がるギャラクシーIP',
			ava1_2:
				'ギャラクシーコーポレーションは、有名人のメタバースアバターを制作し、
様々な領域のマルチバースIPに拡張します。
80チーム余りのセレブ、芸能人とのコラボレーション経験を通じて
韓国最大/最多のアバターIP事業ノウハウ及びポートフォリオを保有しています。',
			ava1_3: '無限拡張ギャラクシーマルチメタバース世界観',
			ava1_4:
				'ミリネの世界は、光を通じた現実の世界「Light on」と光が消えたときに見える仮想世界「Balck on」に分かれています。
現実の世界の私たちは、多くの刹那の線に沿って人生が流れていきます。
瞬間と選択が交差する交差点が現在の姿を成し、
数多くの瞬間の中で夢を想像する瞬間、私が想像する夢が実現します。',
			ava1_5:
				'AVAは、現実の夢を実現させ、様々な夢を経験し、現実と未来を超連結させるギャラクシーの核心価値です。
ギャラクシーは、様々な夢をAVAを通じて実現し、より大きな世界とより多くの人々をつなげ、日常の新しい経験を超えて、夢と希望のメッセージで世界を変化させるために努力しています。',
			ava1_6: 'ギャラクシーコーポレーションのアーティストと専門家',
			ava1_7:
				'ギャラクシーコーポレーションは、無限のポテンシャルを有する様々なアーティストや専門家を継続的に発掘し、
ギャラクシーメタバース事業においてうまく互換できるように交感しつつ、マネジメントを持続的に連携しています。
ギャラクシーヒューマンは、韓国初のグローバルメタバースクリエイターとして、より大きな世界と無限の可能性を以って共に成長することができます。
ギャラクシーは、成長可能な様々なオリジンクリエイターを目指してサポートしています。',
			media1_1: 'メディアコンテンツ',
			media1_2:
			...
			cms1_6:
				'「長年蓄積されたノウハウに基づいて
コマースブランディング、サービス、デザイン
そしてマーケティングまでオン·オフラインを網羅した
Eコマース関連の諸業務を提供します。」',
			cms1_7: '入店チャンネル',
			...
			test1_5_2:
				'また、各プラットフォームにおいては、アバターの機能が制限されているため、ユーザーは様々なプラットフォームでも同じ経験を体験することが困難です。 そのため、ギャラクシーコーポレーションの目標は
「一つのアバターでマルチプラットフォームを体験するサービス」を提供することにより、ユーザーが様々なプラットフォームでも一貫したアバターを使用できるようにすることです。',
			...
			care1_9: '文化',
			care1_10: '自由に意見を示し、お互いを尊重する 水平的なコミュニケーション文化',
			care1_10_1: '個々人ではなくチームワークで業務をして
成果を達成する組織',
			care1_10_2:
				'団体活動を通じてチームワークを向上させることができるよう 四半期ごとのワークショップを運営',
			care1_10_3: '会社で推進するプロジェクトを
全役職員が共有する文化',
...
休暇と費用、用品を支援します。',
			...
			care1_16: '家族愛支援',
			care1_17: 'お母さん、お父さんになりたい構成員に
休暇と費用を支援します。',
			care1_18: '文化生活支援',
			care1_19:
				'楽しい文化生活のために映画、ミュージカル、スポーツ競技など 団体観覧を支援します。',
			care1_20: 'ドリンク&スナックバー',
			care1_21: '構成員が小腹を空けないように スナックやドリンクを提供しています。',
			care1_22: '勤務装備支援',
			care1_23: '職務別に最適化された装備とソフトウェアを
提供しています。',
			care1_24: '同好会',
			care1_25:
				'構成員の趣味活動と相互親睦を深めるため 
...
保障性保険料と実損医療費を支援します。',
			care1_28: '人間ドック',
			care1_29: '構成員の健康のために毎年１回無料で検査し、
休暇も提供します。',
			care1_30: 'マインドケア',
			care1_31:
				'ネガティブな心の状態をポジティブに回復できるよう、
専門相談を支援しています。',
			care1_32: '採用フロー',
			news1: 'ギャラクシーニュース',
			news2: '報道資料',
			news3:
				'ギャラクシーコーポレーション、
「規制革新大賞中小ベンチャー企業部長官賞」受賞の栄誉',
			news4: '「アバドリーム」、夢と希望を伝える。
「特別観戦ポイント」３',
			news5: 'メディア',
			news11: 'ギャラクシーニュース',
			news12: '報道資料',
